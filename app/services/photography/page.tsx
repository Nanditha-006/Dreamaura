    ...
    <Layout headerStyle={1} footerStyle={1}>
      <>
        ...
        >
          ...
          >
            At <strong>Dream Aura Events</strong>, we don’t just capture
            moments—we preserve memories. Our professional photographers
          ...
          <p style={{ fontSize: "16px", lineHeight: "1.8" }}>
            ...
            and eye for detail, our team ensures every shot tells a story—be it
            the sparkle of your entry, the laughter of loved ones, or the
            grandeur of your décor.
          </p>
          ...
          <p style={{ fontSize: "16px", lineHeight: "1.8" }}>
            ...
            exchanged across the mandap—we capture the invisible magic others
