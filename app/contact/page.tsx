...
export default function Contact() {
  ...
  try {
    const response = await fetch("https://sheetdb.io/api/v1/9r1sss8ljkjin", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
      body: JSON.stringify({ data: formData }), // ✅ IMPORTANT
    });
        ...
        <div className="contact2-bg-section">
          ...
          <div className="mapouter">
            <div className="gmap_canvas">
              <iframe
                src="https://www.google.com/maps/embed?... (map URL)"
                width={600}
                height={450}
                style={{ border: 0 }}
                allowFullScreen
