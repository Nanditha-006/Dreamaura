                            ...
                            <div className="col-lg-12">
                                <div className="header-elements">
                                    <div className="site-logo">
                                        <Link href="/"><img src="/assets/img/logo/logo4.png" alt="Dream Aura Events Logo" /></Link>
                                    </div>
                                                            ...
                                                            <div className="all-images-menu">
                                                                <div className="homemenu-thumb">
                                                                    ...
                                                                    <div className="homemenu-btn">
                                                                        <Link className="vl-btn6" href="/"><span className="demo">View Demo <img src="/assets/img/icons/arrow2.svg" alt="Arrow Icon" /></span></Link>
                                                                    </div>
                                    ...
                                    <div className="btn-area">
                                        ...
                                        <div className="btn-area1">
                                            <Link className="vl-btn6" href="/pricing-plan"><span className="demo">Get a Quote</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span></Link>
                                        </div>
                                    </div>
